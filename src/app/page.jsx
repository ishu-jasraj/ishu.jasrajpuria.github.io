...
import Cashinvoice from '@/images/logos/cashinvoice.png'
import EnvestnetYodlee from '@/images/logos/envestnet_yodlee.png'
import Antwalk from '@/images/logos/antwalk.png'
...
function SocialLink({ icon: Icon, target, rel, ...props }) {
  return (
    <Link className="group -m-1 p-1" target={target} rel={rel} {...props}>
    ...
    <>
      <Container className="mt-9">
        <div className="max-w-2xl">
          ...
          <p className="mt-6 text-base text-zinc-600 dark:text-zinc-400">
            I’m a Full-Stack Engineer with 5 years of experience building products used by real teams at scale. 
            Currently at H&M, I work on a global marketing platform used by H&M employees worldwide, owning features from frontend to backend using React, Next.js, Node.js, and TypeScript, deployed on Azure.
            I enjoy diving deep into distributed systems, cloud-native architectures on AWS, and building services that scale globally.
          </p>
          <div className="mt-6 flex gap-6 items-center flex-wrap">
            <SocialLink
              target="_blank"
              rel="noopener noreferrer"
              href="https://www.linkedin.com/in/ishu-jasrajpuria-186620148/"
            ...
            <SocialLink
              target="_blank"
              rel="noopener noreferrer"
              href="https://github.com/ishu-jasraj"
